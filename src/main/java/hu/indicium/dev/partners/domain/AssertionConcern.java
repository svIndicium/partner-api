...
public class AssertionConcern {
    ...
    protected void assertArgumentLength(Collection<?> collection, int aMaximum, String aMessage) {
    ...
    protected void assertArgumentLength(Collection<?> collection, int aMinimum, int aMaximum, String aMessage) {
        int length = collection.size();
        if (length < aMinimum || length > aMaximum) {
            throw new IllegalArgumentException(aMessage);
        }
    ...
    protected void assertArgumentIsValidByRegex(String aString, String aPattern, String aMessage) {
